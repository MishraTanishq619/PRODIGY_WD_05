...
const page = () => {
	...
	return (
		<div className="flex h-4/5 w-4/5 text-white border-4 border-solid border-black absolute left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] bg-slate-400 bg-opacity-60">
			<div className="border-4 border-solid border-black w-1/2 m-1 flex flex-col px-6">
				<h1 className="mx-auto text-5xl underline font-bold my-8">
					Your Location:&nbsp;
					{Loc ? Loc.Lat.toFixed(2) + " , " + Loc.Lon.toFixed(2) : ""}
				</h1>
				<br />
				<h2 className="text-8xl mx-auto">
			...
			<div className="border-4 border-solid border-black w-1/2 m-1 flex flex-col px-6">
				<h1 className="mx-auto text-5xl underline font-bold my-8">
					Location :{" "}
					<input
						className="border-4 px-2 border-solid border-black text-black w-60"
						type="text"
						value={City}
						onChange={(e) => {
